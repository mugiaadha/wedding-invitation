            ...
            <div class="row">
                <div class="col-12 my-5 py-5" align="center">
                    <div class="erika-text">
                        ...
                        <br>
                        <h1 style="color:#fff; font-size:50px">Erika & Mugia</h1>
                        <br>
                        <p style="color:#fff; font-size:16px;">Minggu, 01 September 2024<br>Kepada Yth. Bapak/Ibu/Saudara/i</p>
                        <br>
                        <h2 style="color:#fff;">{{ $name ?? 'test' }}</h2>
                        <br>
                        <p style="color:#fff; font-size:15px;">*Mohon maaf apabila ada kesalahan penulisan nama dan gelar</p>
                        <br>
                        <button class="btn btn-default" style="border: 1px solid #fff; color:#fff;" onclick="soundOn()">
